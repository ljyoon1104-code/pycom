export type LearningExample = {
  id: string; collection: "basic" | "textbook" | "core"; page?: number; order: number;
...
export const TOPICS = ["변수·자료형", "입력·출력", "조건문", "반복문", "리스트·컬렉션", "함수", "클래스", "파일 입출력", "예외 처리", "random", "datetime", "math", "turtle"];
