...
app.innerHTML = `<main class="app"><header class="topbar"><div class="filename"><span class="current-name">main.py</span><span class="modified" aria-label="수정됨"></span></div><div class="actions"><button class="files-toggle" type="button">파일</button><button class="new-file" type="button">새 파일</button><button class="save" type="button">저장</button><button class="save-as" type="button">다른 이름으로</button><button class="import" type="button">가져오기</button><button class="export" type="button">내보내기</button><button class="delete-file" type="button">삭제</button><button class="stop" type="button" disabled>중지</button><button class="run" type="button">실행</button></div></header><section class="workspace"><aside class="file-panel" aria-label="파일 목록"><div class="panel-heading">파일</div><div class="file-list"></div></aside><section class="panel"><div class="panel-heading">코드 편집기</div><div class="editor-host"></div><div class="editor-tools"><button class="tab-button" type="button">Tab</button></div></section><section class="panel result-panel"><div class="panel-heading">실행 결과</div><div class="result-tabs" role="tablist" aria-label="실행 결과 종류"><button class="result-tab selected" data-result-tab="text" role="tab" aria-selected="true" type="button">텍스트</button><button class="result-tab graphics-tab" data-result-tab="graphics" role="tab" aria-selected="false" type="button" hidden>그래픽</button></div><section class="result-view text-view"><button class="clear" type="button">결과 지우기</button><div class="console" aria-live="polite"><span class="console-empty">실행 결과가 여기에 표시됩니다.</span></div></section><section class="result-view graphics-view" hidden><p class="graphics-help">원점은 가운데이며, 위쪽이 양의 y 방향입니다.</p><div class="turtle-canvas-wrap"><canvas class="turtle-canvas" aria-label="거북이 그래픽"></canvas></div></section></section></section><div class="dialog-layer" hidden><section class="save-dialog" role="dialog" aria-modal="true" aria-labelledby="save-question"><p id="save-question">변경 사항을 저장하시겠습니까?</p><div><button data-choice="save" type="button">저장</button><button data-choice="discard" type="button">저장하지 않음</button><button data-choice="cancel" type="button">취소</button></div></section></div></main>`;
...
const importFile = () => {
  ...
  select.value = "auto"; error.hidden = true; error.textContent = ""; input.value = ""; importLayer.hidden = false; select.focus();
  const close = () => { importLayer.hidden = true; input.value = ""; };
